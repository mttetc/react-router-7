 ...
 */
export function validateFilters(filters: Partial<FilterState>): ValidationResult {
 ...
 */
export function sanitizeFilters(filters: Partial<FilterState>): Partial<FilterState> {
