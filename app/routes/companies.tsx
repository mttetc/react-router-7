 ...
 * - React Query calls getCompaniesClient() directly
 * - getCompaniesClient() calls getCompaniesServer() without HTTP overhead
 * - Same data source, optimized for both SSR and client-side
 */
